        ...
        for i in cols:
            if i < total_num:
                if i in popular_song[:50]:
                    ...
                    data.append(50)
                elif i in popular_song[200:400]:
                    data.append(70)
                elif i in popular_song[400:800]:
                    data.append(90)
                elif i in popular_song[800:1600]:
                    data.append(110)
                elif i in popular_song[1600:3200]:
                    data.append(130)
                elif i in popular_song[3200:6400]:
                    data.append(150)
                ...
                #     data.append(110)
                # elif i in popular_song[11000:2330]:
                #     data.append(120)
                # elif i in popular_song[12000:3770]:
                #     data.append(130)
